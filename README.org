#+TITLE: TipXMR - The Livestream Tipping Service for OBS
...
* Installation
If you want to try out TipXMR on your own machine, follow the instructions [[https://github.com/hundehausen/tipdocker][here]].
