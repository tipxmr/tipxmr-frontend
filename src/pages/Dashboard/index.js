...
function Dashboard() {
  ...
  return (
    <div className="flex flex-grow">
      <nav className="px-4 bg-gray-900 w-32 justify-between flex flex-col">
        <div className="items-center">
          <div className="py-4 flex-grow">
            <img
              src={monerologo}
              className="rounded-full transform transition ease-in-out duration-500 hover:scale-125 hover:rotate-360 w-auto h-10 mb-3 m-auto"
            />
          </div>
